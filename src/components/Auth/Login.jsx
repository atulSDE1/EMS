...
//             }}
//             required
//             className='border-2 outline-none border-emerald-600 py-3 px-5 text-xl rounded-full placeholder:text-gray-400' type="email" placeholder='Enter your email'
//           />
//           <input
//             value={password}
//             onChange={(e) => {
...
//             required
//             className='border-2 outline-none border-emerald-600 py-3 px-5 text-xl rounded-full mt-3 placeholder:text-gray-400' type="password" placeholder='Enter password'
//           />
//           <button className=' border-none outline-none bg-emerald-600 py-3 px-20 text-xl rounded-full mt-7'>Log in</button>
//         </form>
//       </div>
//     </div>
//   )
